...
PM_START = """Hello {}, my name is {Miss Delirious}!

You know how hard it is sometimes to manage group so here is the solution for you

I'm group manager bot and Anti-spam for Team Apocalypse 

Activate Anti-spam protection in your BM by this command : 
/antispam on 

Made from the source code of [Hydroxy 🇮🇳](t.me/hydroxy_op)
...
Click /help or Help button below to find out more about how to use me to my full potential.
 ...
 Add me to a group by clicking [here](http://t.me/missdelirious_bot?startgroup=true).
"""
